...
static const char * c2_debug_family_names[4] = { "nargin", "nargout", "x", "y" };
...
static void sf_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  if (CV_EML_IF(0, 1, 0, c2_x < 1.0)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 3);
    c2_a = c2_x;
    c2_b_a = c2_a;
    c2_eml_scalar_eg(chartInstance);
    c2_ak = c2_b_a;
    c2_y = muDoubleScalarPower(c2_ak, 3.0);
  } else {
    ...
    c2_eml_scalar_eg(chartInstance);
    c2_b_ak = c2_d_a;
    c2_y = muDoubleScalarPower(c2_b_ak, 2.0);
  }
...
const mxArray *sf_c2_untitled_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[0].fileTimeLo = 1286815242U;
  ...
  (*c2_b_info)[1].fileTimeLo = 1307647640U;
  ...
  (*c2_b_info)[2].fileTimeLo = 1286815196U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(525365652U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1554931859U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(878736566U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2743226316U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("oWpuoF4kILK5RiNCtNMx9G");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,20,27,41,62);
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3752787764U));
  ssSetChecksum1(S,(3537467429U));
  ssSetChecksum2(S,(631343384U));
  ssSetChecksum3(S,(3372766770U));
